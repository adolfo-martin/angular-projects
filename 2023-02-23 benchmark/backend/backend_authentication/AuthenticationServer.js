...
export default class AuthenticationServer {
    ...
    _configureRoutes() {
        ...
        this._app.post('/rest/login_user', this._validateUser.bind(this));
        // this._app.get('/rest/validate_token', this._validateToken.bind(this));
        // this._app.post('/rest/refresh_token', this._refreshToken.bind(this));
        // this._app.delete('/rest/logout_user', this._deleteUser.bind(this));

        // this._app.get('/rest/users', this._validateTokenMiddleware.bind(this), this._sendUsers.bind(this));
        // this._app.get('/rest/users', this._sendUsers.bind(this));
