...
class PokemonsController {
    ...
    constructor(pokemonsViewModel) {
        ...
        this.#pokemonsViewModel.addEventListener('pokemons-gotten', this.#fillPokemonsTable.bind(this));
        this.#pokemonsViewModel.addEventListener('pokemon-gotten', this.#fillPokemonDetails.bind(this));
